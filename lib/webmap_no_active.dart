...
import 'plan_no_active.dart';

// import 'package:ifp_widgets/ifp_widgets.dart';
// import 'webcam_service.dart';

class WebcamMapNoActive extends StatelessWidget {
  const WebcamMapNoActive({super.key, required this.title});
  ...
  Widget build(BuildContext context) {
    ...
    /// L'image est une ressource (asset)
